...
function updateKeypress(panelID) {
...
function newPanel(panelID, humidity) {
    ...
    theNewPanel += '<div class="push-counter-wrapper clearfix"><div class="push-graph" style="width: 10%"></div><div class="push-counter" id="pushes-';
    theNewPanel += panelID;
